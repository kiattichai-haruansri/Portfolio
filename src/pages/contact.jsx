                    ...
                    <div className='flex-1 flex flex-col'>
                        <form className='flex flex-col justify-around grow h-[50vh] md:h-auto mt-2 md:mt-0'>
                            <div className='h-1/6'>
                                ...
                                <input type="emial" placeholder="E-mail" value={email} onChange={(e) => setEmail(e.target.value)} className='border border-black w-full p-1 rounded-md' />
                            </div>
                            <div className='h-1/6'>
                                <div>Your's Name</div>
                                <input type="text" placeholder="Namel" value={name} onChange={(e) => setName(e.target.value)} className='border border-black w-full p-1 rounded-md' />
                            </div>
                            <div className='grow'>
                                <div>Contact</div>
                            ...
                            <div className=" p-8 rounded-md m-5 flex justify-center">
                                <input className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded w-fit"
